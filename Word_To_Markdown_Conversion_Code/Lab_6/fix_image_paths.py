...
def fix_image_paths():
    ...
    md_file = script_dir / "../../Lab_Markdowns/Lab_6/Lab_6_PAR_soil_moisure_sensor.md"
    ...
    pattern = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_6/media/(image\d+\.\w+)\)\{(.*?)\}'
    ...
    pattern2 = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_6/media/(image\d+\.\w+)\)'
