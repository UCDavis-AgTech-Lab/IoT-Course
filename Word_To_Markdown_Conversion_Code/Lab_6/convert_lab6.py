#!/usr/bin/env python3
"""
Convert Lab 6 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 6 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/6-Week_6/Lab_6_PAR_soil_moisure_sensor.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_6"
    output_file = output_dir / "Lab_6_PAR_soil_moisure_sensor.md"
