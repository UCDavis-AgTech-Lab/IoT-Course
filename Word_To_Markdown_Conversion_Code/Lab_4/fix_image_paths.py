...
def fix_image_paths():
    ...
    md_file = script_dir / "../../Lab_Markdowns/Lab_4/Lab_4_Temp_RH_sensor.md"
    ...
    pattern = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_4/media/(image\d+\.\w+)\)\{(.*?)\}'
    ...
    pattern2 = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_4/media/(image\d+\.\w+)\)'
