#!/usr/bin/env python3
"""
Convert Lab 4 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 4 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/4-Week_4/Lab_4_Temp_RH_sensor.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_4"
    output_file = output_dir / "Lab_4_Temp_RH_sensor.md"
