#!/usr/bin/env python3
"""
Convert Lab 10 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 10 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/10-Week_10_Final_Project/TAE30_final_project.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_10"
    output_file = output_dir / "TAE30_final_project.md"
