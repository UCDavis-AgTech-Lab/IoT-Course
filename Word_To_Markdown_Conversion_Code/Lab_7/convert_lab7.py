#!/usr/bin/env python3
"""
Convert Lab 7 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 7 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/7-Week_7/Lab_7_controlling_actuator.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_7"
    output_file = output_dir / "Lab_7_controlling_actuator.md"
