#!/usr/bin/env python3
"""
Convert Lab 3 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 3 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/3-Week_3/Lab_3_temp_conversion_pass_evaluator.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_3"
    output_file = output_dir / "Lab_3_temp_conversion_pass_evaluator.md"
