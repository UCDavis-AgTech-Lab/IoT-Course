...
def fix_image_paths():
    ...
    md_file = script_dir / "../../Lab_Markdowns/Lab_3/Lab_3_temp_conversion_pass_evaluator.md"
    ...
    pattern = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_3/media/(image\d+\.\w+)\)\{(.*?)\}'
    ...
    pattern2 = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_3/media/(image\d+\.\w+)\)'
