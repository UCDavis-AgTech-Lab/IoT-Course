...
def fix_image_paths():
    ...
    md_file = script_dir / "../../Lab_Markdowns/Lab_8_Part_2/Lab8_sensor_calibration.md"
    ...
    pattern = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_8_Part_2/media/(image\d+\.\w+)\)\{(.*?)\}'
    ...
    pattern2 = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_8_Part_2/media/(image\d+\.\w+)\)'
