...
def fix_image_paths():
    ...
    md_file = script_dir / "../../Lab_Markdowns/Lab_5/Lab_5_ping_sensor_speaker_LED.md"
    ...
    pattern = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_5/media/(image\d+\.\w+)\)\{(.*?)\}'
    ...
    pattern2 = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_5/media/(image\d+\.\w+)\)'
