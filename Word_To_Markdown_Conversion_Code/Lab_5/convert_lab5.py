#!/usr/bin/env python3
"""
Convert Lab 5 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 5 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/5-Week_5/Lab_5_ping_sensor_speaker_LED.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_5"
    output_file = output_dir / "Lab_5_ping_sensor_speaker_LED.md"
