#!/usr/bin/env python3
"""
Convert Lab 9 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 9 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/9-Week_9/Lab_7_IoT_Dashboard.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_9"
    output_file = output_dir / "Lab_7_IoT_Dashboard.md"
