...
def fix_image_paths():
    ...
    md_file = script_dir / "../../Lab_Markdowns/Lab_1/Lab_1_Parallax_activity_board.md"
    ...
    # Pattern: ![...](C:\...\Lab_Markdowns\Lab_1/media/imageX.ext){...}
    pattern = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_1/media/(image\d+\.\w+)\)\{(.*?)\}'
    ...
    pattern2 = r'!\[(.*?)\]\(C:\\.*?\\Lab_Markdowns\\Lab_1/media/(image\d+\.\w+)\)'
