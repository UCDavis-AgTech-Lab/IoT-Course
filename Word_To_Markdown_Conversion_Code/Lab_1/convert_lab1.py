#!/usr/bin/env python3
"""
Convert Lab 1 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 1 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/1-Week_1/Lab_1_Parallax_activity_board.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_1"
    output_file = output_dir / "Lab_1_Parallax_activity_board.md"
