#!/usr/bin/env python3
"""
Convert Lab 8 Part 1 Word document to Markdown using pandoc
"""
...
def main():
    print("Converting Lab 8 Part 1 Word document to Markdown...")
    
    # Set paths
    script_dir = Path(__file__).parent
    input_file = script_dir / "../../Lab_PDFs/8-Week_8_Part_1/Lab_8_Sensor_Accuracy_Evaluation.docx"
    output_dir = script_dir / "../../Lab_Markdowns/Lab_8_Part_1"
    output_file = output_dir / "Lab_8_Sensor_Accuracy_Evaluation.md"
